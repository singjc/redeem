...
const VERSION: &str = "v0.24.0-alphapeptdeep-comparison-export";
...
fn main() -> Result<()> {
    ...
    if !(3..=6).contains(&args.len()) {
        anyhow::bail!(
            "usage: foundation_export_alphapeptdeep_comparison_v0240 RUN.yaml UNIFIED_CHECKPOINT OUTPUT_DIR [validation_per_task=all_if_omitted] [rt_train_calibration=256] [seed=20260916]"
        );
    }
